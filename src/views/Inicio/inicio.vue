<template>
  <div class="team">
    <h1 class="subheading grey--text">Inicio</h1>
    <v-container>
      <v-layout row wrap>
        <v-flex sm6 xs12 md6 lg3>
          <v-card class="ma-3">
            ...
            <v-card-actions>
              ...
              <div class="overline">Documentos subidos</div>
            </v-card-actions>
          </v-card>
        </v-flex>
        <v-flex sm6 xs12 md6 lg3>
          <v-card class="ma-3">
            <v-list-item>
              <v-list-item-avatar tile class="mt-n7">
                <v-sheet color="#F44336" width="80" height="80" elevation="10">
                  <v-icon dark large>assignment</v-icon>
                </v-sheet>
              </v-list-item-avatar>
              <v-list-item-content>
                <div class="overline text-right">Licitaciones</div>
                <v-list-item-title class="headline mb-1 text-right"
            ...
            <v-card-actions>
              ...
              <div class="overline">Licitaciones creadas</div>
            </v-card-actions>
          </v-card>
        </v-flex>
        <v-flex sm6 xs12 md6 lg3>
          <v-card class="ma-3">
            <v-list-item>
              <v-list-item-avatar tile class="mt-n7">
                <v-sheet color="#03A9F4" width="80" height="80" elevation="10">
                  <v-icon dark large>check_circle_outline</v-icon>
                </v-sheet>
              </v-list-item-avatar>
              <v-list-item-content>
                <div class="overline text-right">Aprobadas</div>
                <v-list-item-title class="headline mb-1 text-right"
                  >3</v-list-item-title
                >
                <div><v-divider></v-divider></div>
            ...
            <v-card-actions>
              <v-icon text class="ma-2">done_all</v-icon>
              <div class="overline">Licitaciones aprobadas</div>
            </v-card-actions>
          </v-card>
        </v-flex>
        <v-flex sm6 xs12 md6 lg3>
